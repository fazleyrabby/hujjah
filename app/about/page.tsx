    ...
    <div className="min-h-screen bg-[#F8F4F0]">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Hujjah</h1>
          <p className="text-sm font-medium text-teal-600 bg-teal-50 inline-block px-3 py-1 rounded-full mb-4">
            v1.0.0-beta
          </p>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8 text-center">
          <p className="text-xs text-gray-400 uppercase tracking-wider mb-3">Created By</p>
          <a
            href="https://fazleyrabbi.xyz"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-gray-900 font-semibold hover:text-teal-600 transition-colors"
          >
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8">
          <h2 className="text-lg font-semibold text-gray-900 mb-5">Data Sources</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <h3 className="text-sm font-semibold text-gray-900">Quran Text</h3>
                  <span className="text-[10px] font-bold text-green-700 bg-green-100 px-2 py-0.5 rounded-full">VERIFIED</span>
                </div>
                <p className="text-xs text-gray-500 mt-1">Uthmani script from Tanzil.net — 6,236 verses</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mt-1">English & Bengali from Tanzil.net — 68,596 rows</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <h3 className="text-sm font-semibold text-gray-900">Hadith Corpus</h3>
                  <span className="text-[10px] font-bold text-amber-700 bg-amber-100 px-2 py-0.5 rounded-full">COMING SOON</span>
                </div>
                <p className="text-xs text-gray-500 mt-1">Sanadset 650K Data on Hadith Narrators</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mt-1">all-MiniLM-L6-v2 via Transformers.js — 100% offline</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-900 hover:border-gray-300 hover:shadow-sm transition-all"
          >

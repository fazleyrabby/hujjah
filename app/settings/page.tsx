  ...
  return (
    <div className="min-h-screen bg-base dark:bg-[#0a0a0a]">
      <div className="max-w-2xl mx-auto px-6 py-8">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Dev Settings</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">Native SQLite via Tauri — Quran Vault</p>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl p-5 mb-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            <div className="p-3 bg-gray-50 dark:bg-zinc-800 rounded-lg">
              <div className="text-2xl font-bold text-gray-900 dark:text-white">{stats.verses.toLocaleString()}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Arabic verses</div>
            </div>
            <div className="p-3 bg-gray-50 dark:bg-zinc-800 rounded-lg">
              <div className="text-2xl font-bold text-teal-600 dark:text-teal-400">{stats.translations.toLocaleString()}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Translations</div>
            </div>
            <div className="p-3 bg-gray-50 dark:bg-zinc-800 rounded-lg">
              <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">{stats.languages}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Languages</div>
            </div>
          </div>
          <p className="text-xs text-gray-400 dark:text-gray-500">FTS5 full-text index on translations</p>
        </div>

        {/* Model Status */}
        <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl p-5 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">AI Model Status</h2>
        ...
        {/* Seeding Info */}
        <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl p-5 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Pre-baked Database</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            The unified Quran vault is pre-built on the dev machine using:
          </p>
          <code className="block bg-gray-900 dark:bg-zinc-800 text-gray-100 dark:text-gray-200 text-xs p-3 rounded-lg mb-4">
            npm run build:quran
          </code>
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
            This generates <code className="bg-gray-100 dark:bg-zinc-800 px-1 rounded text-gray-900 dark:text-white">src-tauri/resources/hujjah-quran.db</code> with:
          </p>

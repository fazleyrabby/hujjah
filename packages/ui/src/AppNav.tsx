...
export default function AppNav({
  ...
  return (
    <div className={`${containerClass} mx-auto px-4 sm:px-6 h-14 flex items-center justify-between`}>
      {/* Left section */}
      <div className="flex items-center gap-1">
        {/* Logo */}
        <Link
          href="/"
          className="flex items-center gap-2 text-base font-bold text-gray-900 dark:text-white tracking-tight hover:text-teal-600 dark:hover:text-teal-400 transition-colors px-2 py-1.5 rounded-lg"
        >
        ...
        {/* Divider */}
        <div className="hidden sm:block w-px h-5 bg-gray-200 dark:bg-zinc-700 mx-2" />
      ...
      <div className="flex items-center gap-2">
        ...
        <Link
          href="/settings"
          className="p-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-lg transition-colors"
          title="Settings"
        >

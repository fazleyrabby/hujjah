...
fn model_catalog() -> Vec<ModelInfo> {
    vec![
        ModelInfo {
            ...
            description: "384-dim sentence embeddings for semantic search. Required.".to_string(),
            size_mb: 23,
            min_ram_gb: 2,
        ...
        ModelInfo {
            id: "qwen-onnx".to_string(),
            name: "Qwen 2.5-0.5B Instruct (ONNX)".to_string(),
            description: "Lightweight text generation. Good for basic Q&A and summaries.".to_string(),
            size_mb: 512,
            min_ram_gb: 4,
            recommended_ram_gb: 8,
            url: "".to_string(), // Placeholder — user must provide or we fill later
            model_type: "generation".to_string(),
            bundled: true,
        },
        ModelInfo {
            id: "qwen2.5-1.5b-onnx".to_string(),
            name: "Qwen 2.5-1.5B Instruct (ONNX)".to_string(),
            description: "Better reasoning and longer coherent responses.".to_string(),
            size_mb: 1024,
            min_ram_gb: 6,
        ...
        ModelInfo {
            id: "qwen2.5-3b-onnx".to_string(),
            name: "Qwen 2.5-3B Instruct (ONNX)".to_string(),
            description: "High-quality generation with strong reasoning.".to_string(),
            size_mb: 2048,
            min_ram_gb: 8,
        ...
        ModelInfo {
            id: "qwen2.5-7b-onnx".to_string(),
            name: "Qwen 2.5-7B Instruct (ONNX)".to_string(),
            description: "Best quality responses. Requires significant RAM.".to_string(),
            size_mb: 4096,
            min_ram_gb: 12,

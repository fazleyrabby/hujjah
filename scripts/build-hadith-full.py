#!/usr/bin/env python3
"""
Build Hadith Vault — FULL: All 650K Hadith

Creates src-tauri/resources/hujjah-hadith-full.db from Sanadset 650K CSV chunks.
Seeds ALL books (652K hadith, 2,012 books).
WARNING: This takes ~10-15 minutes and produces a ~2.4GB database.
"""
...
DB_PATH = OUTPUT_DIR / "hujjah-hadith-full.db"
BATCH_SIZE = 1000

# Kutub al-Sittah (canonical 6 books) — exact names from dataset
# English mapping for display (used for all 2,012 books)
BOOK_NAMES_EN = {
...
def main():
    ...
    # Now seed ALL hadith (full 650K)
    print(f"\n📖 Seeding FULL hadith corpus (all 652K rows)...")
    cur = db.cursor()

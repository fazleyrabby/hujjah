...
const SOURCES: Array<(surah: number, ayah: number) => string> = [
  (s, a) => `https://verses.quran.com/Alafasy/mp3/${pad3(s)}${pad3(a)}.mp3`,
  (s, a) => `https://cdn.islamic.network/quran/audio/128/ar.alafasy/${toGlobalAyah(s, a)}.mp3`,
  (s, a) => `https://everyayah.com/data/Alafasy_128kbps/${pad3(s)}${pad3(a)}.mp3`,
];

async function tryFetch(url: string, rangeHeader: string | null, timeoutMs: number) {
